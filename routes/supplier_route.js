...
router.post('/post', checkAuth,supplier_controller.validate(),supplier_controller.supplier_post);
router.get('/get', checkAuth,supplier_controller.supplier_get);
router.delete('/:id', checkAuth,supplier_controller.supplier_delete);
router.put('/:id', checkAuth,supplier_controller.validate(),supplier_controller.supplier_update);
